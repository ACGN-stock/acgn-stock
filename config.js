...
export const config = {
  ...
  releaseStocksMinCounter: 15, //公司檢查是否要釋出股票的最小隨機工作檢查次數
  releaseStocksMaxCounter: 30, //公司檢查是否要釋出股票的最大隨機工作檢查次數
  recordListPriceMinCounter: 15, //為所有公司紀錄參考價格的最小隨機工作檢查次數
  recordListPriceMaxCounter: 30, //為所有公司紀錄參考價格的最大隨機工作檢查次數
