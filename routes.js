...
announcementRoute.route('/new', {
  ...
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 新增系統公告`);
  }
});
...
FlowRouter.route('/instantMessage', {
  name: 'instantMessage',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 即時訊息');
  }
});
...
foundationRoute.route('/:page', {
  name: 'foundationList',
  action(params) {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 新創計劃');
    if (Meteor.isClient) {
...
foundationRoute.route('/view/:foundationId', {
  ...
  action(params) {
    if (Meteor.isServer) {
      ...
      DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 新創計劃資訊');
    }
  }
});
foundationRoute.route('/edit/new', {
  ...
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 發起新創計劃');
  }
});
foundationRoute.route('/edit/:foundationId', {
  ...
  action() {
    if (Meteor.isClient) {
      DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 編輯新創計劃');
    }
  }
});
...
ruleDiscussRoute.route('/new', {
  ...
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 建立新議程');
  }
});
...
ruleDiscussRoute.route('/vote/:agendaId', {
  name: 'ruleAgendaVote',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 議程投票');
  }
});
...
controlCenterRoute.route('/sendGift', {
  ...
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 控制中心 - 發送禮物`);
  }
});
